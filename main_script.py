...
def main():
    ...
    print(f'Morgan fingerprint: {MORGAN_FP_DIM}')
    print(f'Morgan reduced: {MORGAN_REDUCED_DIM}')
    print(f'GNN output: {GNN_OUTPUT_DIM}')
    print(f'Fused drug feature: {FUSED_DRUG_DIM} (Morgan {MORGAN_REDUCED_DIM} + GNN {GNN_OUTPUT_DIM})')
